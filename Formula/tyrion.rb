class Tyrion < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tyrionic/tyrionic/releases/download/#{release_tag}/tyrion_macos_aarch64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/tyrionic/tyrionic/releases/download/#{release_tag}/tyrion_linux_x86"
      sha256 "25eb03d1e8869dab80840755e02d1df154dfeeeba61692f5f10802f4d92f338c"
    end
    on_arm do
      url "https://github.com/tyrionic/tyrionic/releases/download/#{release_tag}/tyrion_linux_aarch64"
      sha256 "62132152f20b84a7a07472cb97317b88223d69f1155c7897a27f1a5b3384f0a8"
    end
  end

  resource "tyrion_source" do
    url "https://github.com/tyrionic/tyrionic/archive/refs/tags/#{release_tag}.tar.gz"
